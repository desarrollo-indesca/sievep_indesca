...
class CondicionFluidoBomba(models.Model):
    ...
    temperatura_unidad = models.ForeignKey(Unidades, on_delete = models.CASCADE)
    viscosidad = models.FloatField(null = True)
    viscosidad_unidad = models.ForeignKey(Unidades, on_delete = models.CASCADE)
...
class CondicionesDisenoBomba(models.Model):
    ...
    capacidad_unidad = models.ForeignKey(Unidades, on_delete=models.CASCADE)
    ...
    npsha_unidad = models.ForeignKey(Unidades, on_delete=models.CASCADE)
...
class Bombas(models.Model):
    ...
    modelo = models.CharField(max_length = 45, null = True)
    creado_al = models.DateTimeField(auto_now = True, auto_now_add = True)
