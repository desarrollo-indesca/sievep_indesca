...
AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
        "dc=indesca,dc=local", ldap.SCOPE_SUBTREE, "(objectCategory=Group)"
    )

AUTH_LDAP_GROUP_TYPE = ActiveDirectoryGroupType(name_attr="cn")
AUTH_LDAP_USER_FLAGS_BY_GROUP = {
    "is_superuser": "CN=django-admins,CN=Users,DC=INDESCA,DC=LOCAL",
    "is_staff": "CN=django-admins,CN=Users,DC=INDESCA,DC=LOCAL",
}
...
SECRET_KEY = 'django-insecure-r+q$9%9u7klq)&io^#yte@$07t=p_-q=dbus5@b!17o_6c#y$w'
